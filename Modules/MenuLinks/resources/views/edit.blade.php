                        ...
                        <div class="mt-5 mb-4 tab-content">
                            ...
                            <div class="block tab-pane {{ $isFirst ? 'block' : 'hidden'}}" id="{{$language->code}}">
                                <div class="grid grid-cols-1 gap-x-5 sm:grid-cols-2">
                                    ...
                                    <div class="mb-3">
                                        <label for="slug_{{$language->code}}" class="inline-block mb-2 text-base font-medium">Slug ({{$language->code}})<span class="text-red-500">*</span></label>
                                        <input type="text" id="slug_{{$language->code}}" name="slug[{{$language->code}}]" value="{{old('slug.'.$language->code)}}" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">
                                    </div>
                                    <div class="mb-3">
