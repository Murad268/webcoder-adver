    ...
    <div class="container-fluid group-data-[content=boxed]:max-w-boxed mx-auto">
        ...
        <div class="grid grid-cols-1 gap-x-5 xl:grid-cols-10">
            <div class="card col-span-2">
                <div class="card-body">
                    <div>
                        <form enctype="multipart/form-data" method="post" action="{{ route('siteinfo.update', $model->id) }}">
                            @csrf
                            @method('PATCH')
                                ...
                                <div class="tab-pane {{ $isFirst ? 'block' : 'hidden' }}" id="{{ $language->code }}">
                                    <div class="flex flex-wrap gap-5">
                                        <div class="mb-3 flex-1">
                                            <label for="textArea" class="inline-block mb-2 text-base font-medium">Kopirayt mətni ({{ $language->code }})</label>
                                            <textarea name="copyright_text[{{ $language->code }}]" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" id="textArea" rows="3">{{ old('copyright_text.' . $language->code, $model->getTranslation('copyright_text', $language->code)) }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                @php
                            ...
                            <div class="flex flex-wrap gap-5">
                                <div class="mb-3 flex-1">
                                    ...
                                    <div class="mt-3">
                                        <input multiple name="favicon[]" type="file" class="cursor-pointer form-file border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500">
                                    </div>

                                </div>

                                <div class="mb-3 flex-1">
                                    <label for="footer_logo" class="inline-block mb-2 text-base font-medium">Loqo</label>
                                    ...
                                    <div class="mt-3">
                                        <input multiple name="logo[]" type="file" class="cursor-pointer form-file border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500">
                                    </div>
