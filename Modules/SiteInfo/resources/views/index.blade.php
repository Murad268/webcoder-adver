                    ...
                    <div class="grid grid-cols-12 lg:grid-cols-12 gap-3">
                        <div class="self-center col-span-12 lg:col-span-6">
                            <div style="display: flex; column-gap: 10px" class="dataTables_length" id="alternativePagination_length">
                                @if(\App\Helpers\PermissionHelper::hasPermission(4, 2))
                                    <a href="{{route('siteinfo.create')}}" style="display: flex; justify-content: center; align-items: center; cursor: pointer" class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">əlavə et</a>
                                @endif
                                @if(\App\Helpers\PermissionHelper::hasPermission(4, 4))
                                    <a data-link="{{route('api.siteinfo.delete_selected_items')}}" style="cursor: pointer" type="button" class="delete-all px-4 py-3 text-sm text-purple-500 border border-purple-200 rounded-md bg-purple-50 dark:bg-purple-400/20 dark:border-purple-500/50">
                                        seçilənləri sil
                                    </a>
                                @endif
                            ...
                            <table id="alternativePagination" class="display dataTable w-full text-sm align-middle whitespace-nowrap" style="width:100%" aria-describedby="alternativePagination_info">
                                ...
                                <tbody>
                                    ...
                                    <tr class="group-[.stripe]:even:bg-slate-50 group-[.stripe]:dark:even:bg-zink-600 transition-all duration-150 ease-linear group-[.hover]:hover:bg-slate-50 dark:group-[.hover]:hover:bg-zink-600 [&amp;.selected]:bg-custom-500 dark:[&amp;.selected]:bg-custom-500 [&amp;.selected]:text-custom-50 dark:[&amp;.selected]:text-custom-50">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{route('siteinfo.edit', $item->id)}}" class="btn btn-phoenix-success me-1 mb-1" type="button">
                                                ...
                                                @if($activeItemsCount < 2 or $items->count() < 2) <a style="cursor: none" class="btn btn-phoenix-danger me-1 mb-1" type="link">
                                                        ...
                                                        @else
                                                        <a href="{{route('siteinfo.changeStatusFalse',$item->id)}}" class="btn btn-phoenix-secondary me-1 mb-1 change_status_false" type="link">
                                                        ...
                                                        @else
                                                        <a href="{{route('siteinfo.changeStatusTrue',$item->id)}}" class="btn btn-phoenix-secondary me-1 mb-1 change_status_true" type="button">
